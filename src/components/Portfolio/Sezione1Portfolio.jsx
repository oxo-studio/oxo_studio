import LavoroCard from "./LavoroCard"; // importa il nuovo componente
import categoriePortfolio from "../CategoriePortfolio/FileCategorie";
import LavoroCardBasso from "./LavoroCardBasso";
...
const Sezione1Portfolio = () => {
  ...
  return (
    <div className="relative mt-[10px] md:mt-[530px] lg:mt-[40px] flex flex-col items-center">
      {/* Parte superiore */}
      ...
      {/* Parte inferiore */}
      <div className="relative z-10 w-[90vw] h-[55vh] border border-white overflow-hidden hidden md:block grid-cols-2">
        {/* Colonna sinistra */}
